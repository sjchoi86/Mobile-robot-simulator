function h = draw_arrow(fr, dist, deg, color, thick)
...
h = cell(3, 1);
h{1} = plot([fr_x to_x], [fr_y to_y], 'LineWidth', thick, 'Color', color);
h{2} = plot([l_x to_x], [l_y to_y], 'LineWidth', thick, 'Color', color);
h{3} = plot([r_x to_x], [r_y to_y], 'LineWidth', thick, 'Color', color);

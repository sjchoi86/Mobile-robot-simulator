 ...
 *
 * get_pathcosts_data.c
 *
 * Code generation for function 'get_pathcosts_data'
 *
 */
...
emlrtContext emlrtContextGlobal = { true, false, 131418U, NULL, "get_pathcosts",
...
/* End of code generation (get_pathcosts_data.c) */

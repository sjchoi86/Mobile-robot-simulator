 ...
 *
 * get_pathcosts_emxutil.h
 *
 * Code generation for function 'get_pathcosts_emxutil'
 *
 */

#ifndef __GET_PATHCOSTS_EMXUTIL_H__
#define __GET_PATHCOSTS_EMXUTIL_H__
...
/* End of code generation (get_pathcosts_emxutil.h) */
